                ...
                <div class="container">
                    <div class="row">
                        <div class="col-sm-8 col-sm-offset-2 text">
                            <h1><strong>Mainô Blog</strong> Login</h1>
                        ...
                        <div class="col-sm-6 col-sm-offset-3 form-box">
                        	<div class="form-top">
                        		<div class="form-top-left">
                        			<h3>Acesse o seu Blog</h3>
                            		<p>Entre com o e-mail e senha:</p>
                        		</div>
					...
					<div class="row">
                        <div class="col-sm-6 col-sm-offset-3 social-login">
                        	<h3>Quer ter um blog?</h3>
                        	<div class="social-login-buttons">
	                        	<a class="btn btn-link-2" href="cria-blog.jsp">
	                        		Cadastre-se aqui!
	                        	</a>
                        	</div>
                        </div>
