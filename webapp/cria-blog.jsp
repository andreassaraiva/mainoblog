			...
			<div class="container">
				<div class="row">
					<div class="col-sm-8 col-sm-offset-2 text">
						<h1><strong>Mainô Blog</strong> Cadastro</h1>
						...
						<div class="form-top">
						 ...
						 <div class="form-bottom">
							<form role="form" action="blog?action=CriaBlog" method="post" class="login-form">
		                        ...
		                        <div class="form-group">
		                    		<label class="sr-only" for="desc_blog">Descrição do Blog</label>
		                        	<textarea name="desc_blog" placeholder="Descrição do Blog" class="form-username form-control" id="desc_blog" required></textarea>
		                        </div>
